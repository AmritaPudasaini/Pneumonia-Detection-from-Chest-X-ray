...
#### This repository contains the Pneumonia Detection from Chest X-ray Images project, which uses deep learning to classify chest X-ray images as Normal or Pneumonia. It includes exploratory data analysis (EDA) performed on the Chest X-ray Balanced Dataset from Kaggle, covering data loading, cleaning, visualization, and preprocessing planning for 9,600 chest X-ray images. The project will continue with the implementation and comparison of a CNN and a DenseNet121 transfer learning model for classifying chest X-rays.